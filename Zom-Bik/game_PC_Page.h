...
namespace ZomBik {
	...
	/// <summary>
	/// Summary for game_PC_Page
	/// </summary>
	public ref class game_PC_Page : public System::Windows::Forms::Form
	{
	public:
		int count = 0;
		int second = 0;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(game_PC_Page::typeid));
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &game_PC_Page::timer1_Tick);
			// 
			// label4
			// 
			...
			this->label4->Location = System::Drawing::Point(590, 182);
			...
			this->timer->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(162)));
			this->timer->Location = System::Drawing::Point(684, 157);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(162)));
			this->label3->Location = System::Drawing::Point(590, 157);
			...
			this->label31->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(162)));
			this->label31->Location = System::Drawing::Point(328, 18);
			...
			this->label30->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(162)));
			this->label30->Location = System::Drawing::Point(23, 43);
			...
			this->label27->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(162)));
			this->label27->Location = System::Drawing::Point(775, 182);
			...
			this->label24->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(162)));
			this->label24->Location = System::Drawing::Point(418, 74);
			...
			this->tamam->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(162)));
			this->tamam->Location = System::Drawing::Point(423, 157);
			this->tamam->Name = L"tamam";
			this->tamam->Size = System::Drawing::Size(161, 50);
			this->tamam->TabIndex = 132;
			this->tamam->Text = L"Tamam";
			this->tamam->UseVisualStyleBackColor = false;
			this->tamam->Click += gcnew System::EventHandler(this, &game_PC_Page::tamam_Click);
			// 
			// textBox1
			// 
			...
			this->textBox1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(162)));
			this->textBox1->Location = System::Drawing::Point(423, 110);
			...
			this->listBox2->Location = System::Drawing::Point(324, 71);
			...
			this->listBox1->Location = System::Drawing::Point(28, 71);
			...
			this->menu->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(162)));
			this->menu->Location = System::Drawing::Point(678, 529);
			this->menu->Name = L"menu";
			this->menu->Size = System::Drawing::Size(142, 39);
			this->menu->TabIndex = 126;
			this->menu->Text = L"Ana Menü";
			this->menu->UseVisualStyleBackColor = false;
			this->menu->Click += gcnew System::EventHandler(this, &game_PC_Page::menu_Click);
			// 
			// game_PC_Page
			// 
			...
			this->ClientSize = System::Drawing::Size(846, 583);
			...
			this->Name = L"game_PC_Page";
			this->Text = L"Bilgisayar ile Normal Çarpým";
			this->Load += gcnew System::EventHandler(this, &game_PC_Page::game_PC_Page_Load);
...
private: System::Void game_PC_Page_Load(System::Object^  sender, System::EventArgs^  e) {
	timer1->Enabled = true;
	string s;
	string ss;
	tutulan = new string();
